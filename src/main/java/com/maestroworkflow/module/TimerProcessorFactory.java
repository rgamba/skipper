...
public class TimerProcessorFactory {
    ...
    @Inject
    public TimerProcessorFactory(@NonNull TimerStore timerStore, @NonNull DecisionTimerHandler decisionTimerHandler,
    ...
    public TimerProcessor create(@NonNull MaestroEngine engine) {
        val timerHandlers = new HashMap<Class<? extends TimerHandler>, TimerHandler>(){{
