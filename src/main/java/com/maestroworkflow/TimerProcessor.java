...
public class TimerProcessor {
    ...
    @Inject
    public TimerProcessor(@NonNull MaestroEngine engine, @NonNull TimerStore timerStore,
    ...
    private void processTimer(Timer t) {
        ...
        try {
            ...
            if (!timerStore.delete(t)) {
                logger.info("unable to delete the timer as it was probably updated by the handler. timer={}", t);
            }
        } catch (Exception e) {
