...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            ...
            <form class="form-inline my-2 my-lg-0" onsubmit="searchWorkflowInstance(); return false">
...
<#--                    <th scope="col"></th>-->
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" onclick="navigateToWorkflow('{{response.childWorkflowInstanceId}}'); return false;">View workflow</a>
                        {{else}}
                        {{#if_eq request.operationType.clazzType 'WORKFLOW'}}
                        <a href="#" onclick="view_workflow_by_correlation_id('{{request.operationRequestId}}');">View workflow</a>
                        {{else}}
...
<script>
    ...
    function searchWorkflowInstance() {
        document.location.href = '#workflow/' + $('#searchBox').val();
    }

    function navigateToWorkflow(id) {
        document.location.href = '#workflow/' + id;
    }
     ...
     */
    function view_workflow_internal(url) {
        $.get(url, function(response) {
            ...
            $.get("/admin/workflow-instances/" + response.id + "/operation-responses", function(history_response) {
                ...
                $("#main_content").html(workflow_detail_view(response));
                navigateToWorkflow(response.id);
            });
        });
    }

    function view_workflow(id) {
        view_workflow_internal("/admin/workflow-instances/" + id)
    }

    function view_workflow_by_correlation_id(id) {
        view_workflow_internal("/admin/workflow-instances/by-correlation-id/" + id)
    }
